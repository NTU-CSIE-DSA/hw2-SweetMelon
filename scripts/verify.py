...
HAS_LANG_JAVA = False # get_bool_environ('HAS_LANG_JAVA')
HAS_LANG_PASCAL = False # get_bool_environ('HAS_LANG_PASCAL')
HAS_LANG_PYTHON = False # get_bool_environ('HAS_LANG_PYTHON')
